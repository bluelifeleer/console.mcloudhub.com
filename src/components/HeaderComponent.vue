<template>
  <div class="header-container">
    <div class="header-user-info-box">
      <a href="javascript:void(0);" class="user-info-bar" :user-id="user._id" @click="showUserSettingPopupToggle($event,true)"><img v-if="user.avatar" :src="user.avatar"
          alt=""><img v-else src="../assets/25da6df20473dab1a0eb8b5fea3e5d79_t.gif" alt=""><span
          class="user-name">{{user.name}}</span><i class="icon iconfont">&#xe63a;</i></a>
