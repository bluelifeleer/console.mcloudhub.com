    ...
    <div class="add-item-dialog" v-if="addItemDialog">
      ...
      <div class="add-item-dialog-box">
        <div class="add-item-dialog-header">
          <span>添加详情</span>
          <a href="javascript:void(0);" class="add-item-dialog-close-but" @click="addItemDialogCloseBut($event)"><i
              class="icon iconfont add-item-dialog-close-icon">&#xe60b;</i></a>
        </div>
        <div class="add-item-dialog-body">
          <div class="add-item-form">
            ...
            <div class="add-item-form-items">
              ...
              <el-date-picker v-model="addItemForm.dateTime" type="datetime" placeholder="选择日期时间" align="right"
                :picker-options="pickerOptions" size="large">
              </el-date-picker>
            </div>
            <div class="add-item-form-items">
