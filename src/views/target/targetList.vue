  ...
  <div class="target-list-page">
    ...
    <div class="target-list-page-body">
      <div class="target-list-group">
        <el-table :data="targets.list" style="width: 100%" v-loading="loading" height="550" max-height="550">
      ...
      <div class="target-pagination-box">
        <el-pagination @size-change="targetsHandleSizeChange" @current-change="targetsHandleCurrentChange" :current-page="targets.offset" :page-sizes="[10, 20, 40, 60, 80, 100]" :page-size="targets.nums" layout="total, sizes, prev, pager, next, jumper" :total="targets.count">
        </el-pagination>
      </div>
    </div>
