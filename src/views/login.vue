    ...
    <div class="login-box">
      ...
      <div class="login-form-box">
        <div class="login-form-items">
          ...
          <input type="text" name="name" :placeholder="form.name.placeholder" v-model="form.name.value"
            autocomplete="off" />
        ...
        <div class="login-form-items">
          ...
          <input type="password" name="password" :placeholder="form.password.placeholder" v-model="form.password.value"
            autocomplete="off" />
